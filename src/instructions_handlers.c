...
const instr_fn INSTR_HANDLERS[256] = {
    ...
    // 0x1_
    [0x10] = BPL_,     [0x11] = ORA,      [0x12] = ORA,        [0x13] = SLO,
    ...
    // 0x3_
    [0x30] = BMI_,     [0x31] = AND,      [0x32] = AND,        [0x33] = RLA,
    ...
    // 0x5_
    [0x50] = BVC_,     [0x51] = EOR,      [0x52] = EOR,        [0x53] = SRE,
    ...
    // 0x7_
    [0x70] = BVS_,     [0x71] = ADC,      [0x72] = ADC,        [0x73] = RRA,
    ...
    [0x88] = DEY,      [0x89] = BIT,      [0x8A] = TXA,        [0x8B] = op_illegal,
    [0x8C] = STY,      [0x8D] = STA,      [0x8E] = STX,        [0x8F] = BBS_,

    // 0x9_
    [0x90] = BCC_,     [0x91] = STA,      [0x92] = STA,        [0x93] = op_illegal,
    ...
    // 0xB_
    [0xB0] = BCS_,     [0xB1] = LDA,      [0xB2] = LDA,        [0xB3] = LAX,
    ...
    // 0xD_
    [0xD0] = BNE_,     [0xD1] = CMP,      [0xD2] = CMP,        [0xD3] = DCP,
    ...
    // 0xF_
    [0xF0] = BEQ_,     [0xF1] = SBC,      [0xF2] = SBC,        [0xF3] = ISC,
