...
const INST INST_TABLE[0x10][0x10] = {
    // 0x0_
    {
        ...
        {"NOP",ADDR_IMM,REG_NONE,REG_NONE},
        {"SLO",ADDR_NONE,REG_NONE,REG_NONE},
    ...
    // 0x1_
    {
        ...
        {"ORA",ADDR_ZP_IND,REG_A,REG_NONE},
        {"SLO",ADDR_NONE,REG_NONE,REG_NONE},
    ...
    // 0x2_
    {
        ...
        {"NOP",ADDR_IMM,REG_NONE,REG_NONE},
        {"RLA",ADDR_NONE,REG_NONE,REG_NONE},
    ...
    // 0x3_
    {
        ...
        {"AND",ADDR_ZP_IND,REG_A,REG_NONE},
        {"RLA",ADDR_NONE,REG_NONE,REG_NONE},
        {"BIT",ADDR_ZPX,REG_NONE,REG_NONE},
        ...
        {"DEC",ADDR_ACC,REG_A,REG_A},
        {"RLA",ADDR_NONE,REG_NONE,REG_NONE},
        {"BIT",ADDR_ABSX,REG_NONE,REG_NONE},
    ...
    // 0x4_
    {
        ...
        {"NOP",ADDR_IMM,REG_NONE,REG_NONE},
        {"SRE",ADDR_NONE,REG_NONE,REG_NONE},
        {"NOP",ADDR_ZP,REG_NONE,REG_NONE},
    ...
    // 0x5_
    {
        ...
        {"EOR",ADDR_ZP_IND,REG_A,REG_NONE},
        {"SRE",ADDR_NONE,REG_NONE,REG_NONE},
        {"NOP",ADDR_ZPX,REG_NONE,REG_NONE},
        ...
        {"SRE",ADDR_NONE,REG_NONE,REG_NONE},
        {"NOP",ADDR_ABS,REG_NONE,REG_NONE},
    ...
    // 0x6_
    {
        ...
        {"NOP",ADDR_IMM,REG_NONE,REG_NONE},
        {"RRA",ADDR_NONE,REG_NONE,REG_NONE},
    ...
    // 0x7_
    {
        ...
        {"ADC",ADDR_ZP_IND,REG_A,REG_NONE},
        {"RRA",ADDR_NONE,REG_NONE,REG_NONE},
        ...
        {"RRA",ADDR_NONE,REG_NONE,REG_NONE},
        {"JMP",ADDR_ABS_IND_X,REG_NONE,REG_NONE},
    ...
    // 0x8_
    {
        ...
        {"NOP",ADDR_IMM,REG_NONE,REG_NONE},
        {"SAX",ADDR_NONE,REG_NONE,REG_NONE},
        ...
        {"BIT",ADDR_IMM,REG_NONE,REG_NONE},
        {"TXS",ADDR_NONE,REG_X,REG_SP},
        {"KIL",ADDR_NONE,REG_NONE,REG_NONE},
    ...
    // 0x9_
    {
        ...
        {"STA",ADDR_ZP_IND,REG_A,REG_NONE},
        {"KIL",ADDR_NONE,REG_NONE,REG_NONE},
    ...
    // 0xA_
    {
        ...
        {"LAX",ADDR_NONE,REG_NONE,REG_NONE},
    ...
    // 0xB_
    {
        ...
        {"LDA",ADDR_ZP_IND,REG_NONE,REG_A},
        {"LAX",ADDR_NONE,REG_NONE,REG_NONE},
    ...
    // 0xC_
    {
        ...
        {"NOP",ADDR_IMM,REG_NONE,REG_NONE},
        {"DCP",ADDR_NONE,REG_NONE,REG_NONE},
    ...
    // 0xD_
    {
        ...
        {"CMP",ADDR_ZP_IND,REG_A,REG_NONE},
        {"DCP",ADDR_NONE,REG_NONE,REG_NONE},
        {"NOP",ADDR_ZPX,REG_NONE,REG_NONE},
    ...
    // 0xE_
    {
        ...
        {"NOP",ADDR_IMM,REG_NONE,REG_NONE},
        {"ISC",ADDR_NONE,REG_NONE,REG_NONE},
    ...
    // 0xF_
    {
        ...
        {"SBC",ADDR_ZP_IND,REG_A,REG_NONE},
        {"ISC",ADDR_NONE,REG_NONE,REG_NONE},
        {"NOP",ADDR_ZPX,REG_NONE,REG_NONE},
        ...
        {"ISC",ADDR_NONE,REG_NONE,REG_NONE},
        {"NOP",ADDR_ABSX,REG_NONE,REG_NONE},
