...
const instr_fn INSTR_HANDLERS[256] = {
    ...
    [0x04] = NOP_READ, [0x05] = ORA,      [0x06] = ASL,        [0x07] = SLO,
    [0x08] = PHP,      [0x09] = ORA,      [0x0A] = ASL,        [0x0B] = op_illegal,
    [0x0C] = NOP_READ, [0x0D] = ORA,      [0x0E] = ASL,        [0x0F] = SLO,

    // 0x1_
    [0x10] = BPL_,     [0x11] = ORA,      [0x12] = op_illegal, [0x13] = SLO,
    [0x14] = NOP_READ, [0x15] = ORA,      [0x16] = ASL,        [0x17] = SLO,
    [0x18] = CLC,      [0x19] = ORA,      [0x1A] = NOP,        [0x1B] = SLO,
    [0x1C] = NOP_READ, [0x1D] = ORA,      [0x1E] = ASL,        [0x1F] = SLO,
    ...
    [0x9C] = op_illegal, [0x9D] = STA,    [0x9E] = op_illegal, [0x9F] = op_illegal,
    ...
    [0xC8] = INY,      [0xC9] = CMP,      [0xCA] = DEX,        [0xCB] = op_illegal,
