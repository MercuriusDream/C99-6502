...
const instr_fn INSTR_HANDLERS[256] = {
    ...
    [0x04] = TSB,      [0x05] = ORA,      [0x06] = ASL,        [0x07] = SLO,
    [0x08] = PHP,      [0x09] = ORA,      [0x0A] = ASL,        [0x0B] = op_illegal,
    [0x0C] = TSB,      [0x0D] = ORA,      [0x0E] = ASL,        [0x0F] = SLO,

    // 0x1_
    [0x10] = BPL_,     [0x11] = ORA,      [0x12] = op_illegal, [0x13] = SLO,
    [0x14] = TRB,      [0x15] = ORA,      [0x16] = ASL,        [0x17] = SLO,
    [0x18] = CLC,      [0x19] = ORA,      [0x1A] = NOP,        [0x1B] = SLO,
    [0x1C] = TRB,      [0x1D] = ORA,      [0x1E] = ASL,        [0x1F] = SLO,
    ...
    [0x9C] = STZ,      [0x9D] = STA,      [0x9E] = STZ,        [0x9F] = op_illegal,
    ...
    [0xD4] = NOP_READ, [0xD5] = CMP,      [0xD6] = DEC,        [0xD7] = DCP,
    [0xD8] = CLD,      [0xD9] = CMP,      [0xDA] = PHX,        [0xDB] = STP,
    [0xDC] = NOP_READ, [0xDD] = CMP,      [0xDE] = DEC,        [0xDF] = DCP,
    ...
    [0xF4] = NOP_READ, [0xF5] = SBC,      [0xF6] = INC,        [0xF7] = ISC,
    [0xF8] = SED,      [0xF9] = SBC,      [0xFA] = PLX,        [0xFB] = ISC,
    [0xFC] = NOP_READ, [0xFD] = SBC,      [0xFE] = INC,        [0xFF] = ISC
};