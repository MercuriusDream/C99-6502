# 6502_functional_test by Klaus Dormann
...
[README_KO.md](/README_KO.md)에서 자세한 내용을 확인하십시오.

## License

This program is licensed under the [GNU General Public License Version 3](./LICENSE).
